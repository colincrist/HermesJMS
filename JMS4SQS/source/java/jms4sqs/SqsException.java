...
public class SqsException extends JMSException
{
   ...
   public SqsException(Exception ex)
   {
      super(ex.getMessage());
    ...
    *           java.lang.String
    */
   public SqsException(String arg1)
   {
      super(arg1);
   }
    ...
    *           java.lang.String
    */
   public SqsException(String arg1, Exception ex)
   {
      super(arg1);
